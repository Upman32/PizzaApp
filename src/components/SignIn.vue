...
const {signUp, errorMessage, toggleModel, signInModalOpen, logIn, logOut, userData} = useAuth();
const formData = ref({
  email:"",
  password:"",
}) 
...
<template>
  {{ userData?.email }}
  <button v-if="!userData" @click="toggleModel" class="sign_in_btn">Sign in</button>
  <button v-else @click="logOut" class="sign_in_btn">Log out</button>
  <div v-if="signInModalOpen" class="modal">
    <div class="modal_content">
    <span @click="toggleModel" class="close_modal">&#10060;</span>
